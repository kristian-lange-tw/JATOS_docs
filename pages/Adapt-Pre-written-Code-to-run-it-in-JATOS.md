---
title: Editing Adapt Pre written Code to run it in JATOS (Jatosify)
...
That's about it. Infos about other jatos.js functions and variables you can find in the [reference](jatos.js-Reference). 
...
* You can add a **quit button** to your study to allow the participant to [abort at any time](Data-Privacy-and-Ethics#things-you-should-consider-in-your-studies). 
